...
public class DocumentController {
    ...
    public String createDocument(@ModelAttribute("form") DocumentForm form) {
        ...
        Member firstApprover = memberRepository.findById(form.getFirstApproverId()).orElseThrow(() -> new UsernameNotFoundException("회원 정보를 찾을 수 없습니다."));

        otherApprovers.add(memberRepository.findById(form.getSecondApproverId()).orElseThrow(() -> new UsernameNotFoundException("회원 정보를 찾을 수 없습니다.")));
        otherApprovers.add(memberRepository.findById(form.getThirdApproverId()).orElseThrow(() -> new UsernameNotFoundException("회원 정보를 찾을 수 없습니다.")));
        otherApprovers.add(memberRepository.findById(form.getFourthApproverId()).orElseThrow(() -> new UsernameNotFoundException("회원 정보를 찾을 수 없습니다.")));
        otherApprovers.add(memberRepository.findById(form.getFifthApproverId()).orElseThrow(() -> new UsernameNotFoundException("회원 정보를 찾을 수 없습니다.")));
